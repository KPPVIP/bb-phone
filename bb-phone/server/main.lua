...
AddEventHandler('phone:server:salty:AcceptCall', function(callerID)
    local src = source
    exports['saltychat']:EstablishCall(callerID, src)
    exports['saltychat']:EstablishCall(src, callerID)
end)

RegisterServerEvent('phone:server:salty:RemoveCall')
AddEventHandler('phone:server:salty:RemoveCall', function(callerID)
    local src = source
    exports['saltychat']:EndCall(callerID, src)
    exports['saltychat']:EndCall(src, callerID)
end)
